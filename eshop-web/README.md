...
git remote add origin https://github.com/sixeyed/gha5.git
```
...
[You can check on the workflows here](https://github.com/sixeyed/gha5/actions). The actions use secrets from your repo to connect to Azure. Then they:
...
```
az aks browse --resource-group eshopweb5 --name eshopweb5-aks
```
